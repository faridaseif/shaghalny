<?php
// public/setup_database.php (Web Accessible)
...
try {
    ...
    echo "Checking and creating tables...<br>";
    ...
    $db->exec($sqlReports);
    echo "Verified 'reports' table.<br>";
    ...
    $db->exec($sqlMessages);
    echo "Verified 'support_messages' table.<br>";

    echo "Database setup completed successfully.";

} catch (Exception $e) {
    die("Setup Error: " . $e->getMessage() . "<br>");
}
